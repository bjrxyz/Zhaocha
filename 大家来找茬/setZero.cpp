    ...
    mclOutputHandlerFcn print_handler)
{
  ...
  if (!mclmcrInitialize())
    return false;
  if (!GetModuleFileName(GetModuleHandle("setZero"), path_to_dll, _MAX_PATH))
    return false;
    {
...
{
  return setZeroInitializeWithHandlers(mclDefaultErrorHandler, mclDefaultPrintHandler);
}
